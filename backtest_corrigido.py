# -*- coding: utf-8 -*-
"""
BACKTEST CORRIGIDO: Estratégia Superávit v2.0 vs Estratégia Antiga
Usando tabela correta: Resultados_INT
Últimos 20 concursos do banco atualizado
"""
...
def get_ultimos_concursos(n=20):
    ...
    for row in cursor.fetchall():
        concurso = row[0]
        numeros = set(row[1:16])  # Já são INT
...
def main():
    print("=" * 80)
    print("🔬 BACKTEST CORRIGIDO: SUPERÁVIT v2.0 vs ESTRATÉGIA ANTIGA")
    print("   Tabela: Resultados_INT (banco atualizado)")
    print("=" * 80)
    print()
    ...
    # Conclusão
    if total_erros_antiga > 0:
        melhoria = ((total_erros_antiga - total_erros_nova) / total_erros_antiga * 100)
    else:
        melhoria = 0
